...
const Points = () => {
    ...
    function handleNvigateToDetail(){
    ...
    <>
        <View style={styles.container}>
            ...
            <View style={styles.mapContainer} >
                <MapView style={styles.map} initialRegion={{latitude: -24.3082729, longitude: -53.5276014, latitudeDelta:0.014 , longitudeDelta: 0.014}}>
                    <Marker 
                        style={styles.mapMarker}
                        onPress={handleNvigateToDetail}
                        coordinate={{latitude: -24.3082729, longitude: -53.5276014}}
                    >
